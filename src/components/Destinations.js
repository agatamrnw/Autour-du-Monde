...
const destinations = [
    ...
    },
    {
      ...
      date: '6.06.2023 - 9.06.2023',
      description: "Nestled in the heart of Europe, the Alps have always been a dream destination for me. The promise of snow-capped peaks, charming alpine villages, and breathtaking landscapes was irresistible. When I finally had the chance to visit, it turned out to be everything I imagined and more",
      image: '/assets/alpes.png'
    },
    {
        id: 'oslo',
        name: 'Oslo, Norway',
